...
bool turtlesim_catch_interfaces__msg__turtleinfo__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("turtlesim_catch_interfaces.msg._turtleinfo.Turtleinfo", full_classname_dest, 53) == 0);
  }
  turtlesim_catch_interfaces__msg__Turtleinfo * ros_message = _ros_message;
  {  // name
...
PyObject * turtlesim_catch_interfaces__msg__turtleinfo__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("turtlesim_catch_interfaces.msg._turtleinfo");
