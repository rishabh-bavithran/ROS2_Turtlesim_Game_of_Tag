...
static const _Turtleinfo_type_support_symbol_names_t _Turtleinfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlesim_catch_interfaces, msg, Turtleinfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlesim_catch_interfaces, msg, Turtleinfo)),
  }
};
...
{
  return &::turtlesim_catch_interfaces::msg::rosidl_typesupport_cpp::Turtleinfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, turtlesim_catch_interfaces, msg, Turtleinfo)() {
  return get_message_type_support_handle<turtlesim_catch_interfaces::msg::Turtleinfo>();
}
