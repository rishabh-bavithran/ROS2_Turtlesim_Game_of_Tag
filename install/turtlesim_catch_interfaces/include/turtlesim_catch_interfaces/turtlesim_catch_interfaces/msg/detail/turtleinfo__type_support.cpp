...
{
  new (message_memory) turtlesim_catch_interfaces::msg::Turtleinfo(_init);
}

void Turtleinfo_fini_function(void * message_memory)
{
  auto typed_message = static_cast<turtlesim_catch_interfaces::msg::Turtleinfo *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Turtleinfo_message_member_array[4] = {
  {
    ...
    offsetof(turtlesim_catch_interfaces::msg::Turtleinfo, name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(turtlesim_catch_interfaces::msg::Turtleinfo, x),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(turtlesim_catch_interfaces::msg::Turtleinfo, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(turtlesim_catch_interfaces::msg::Turtleinfo, theta),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Turtleinfo_message_members = {
  ...
  4,  // number of fields
  sizeof(turtlesim_catch_interfaces::msg::Turtleinfo),
...
{
  return &::turtlesim_catch_interfaces::msg::rosidl_typesupport_introspection_cpp::Turtleinfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlesim_catch_interfaces, msg, Turtleinfo)() {
  return &::turtlesim_catch_interfaces::msg::rosidl_typesupport_introspection_cpp::Turtleinfo_message_type_support_handle;
}
